...
namespace Pamaxie.Website.Services
{
    ...
    public static class JsonWebToken
    {
        ...
        public static string Encode(IBody body, string secret) =>
            Base64UrlEncode(Encoding.UTF8.GetBytes(Encode(body, Encoding.UTF8.GetBytes(secret))));
        ...
        public static IBody? Decode<T>(string token, string secret) =>
            Decode<T>(Encoding.UTF8.GetString(Base64UrlDecode(token)), Encoding.UTF8.GetBytes(secret), true);
